import { z } from "zod";
export const CoeiroinkCharacterSettingSaveModel = z.object({
...
export type CoeiroinkCharacterSettingSaveModel = z.infer<
  typeof CoeiroinkCharacterSettingSaveModel
>;
