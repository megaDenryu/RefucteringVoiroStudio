import { z } from "zod";
export const AIVoiceCharacterSettingSaveModelReq = z.object({
  page_mode: z.string(),
  client_id: z.string(),
  character_id: z.string(),
  aiVoiceCharacterSettingSaveModel: z.object({
...
export type AIVoiceCharacterSettingSaveModelReq = z.infer<
  typeof AIVoiceCharacterSettingSaveModelReq
>;
