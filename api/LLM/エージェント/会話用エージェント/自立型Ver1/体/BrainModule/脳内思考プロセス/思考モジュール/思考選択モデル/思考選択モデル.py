...
class 思考選択モデル(I思考モデル):
    ...
    async def 実行(self, v状況履歴: 状況履歴, v思考履歴: 記憶部署, vキャラクター情報: I自分の情報コンテナ) -> ThinkingMethodSelecter:
        return await self.思考の種類を適当に選ぶ(v状況履歴, v思考履歴, vキャラクター情報)

    async def 思考の種類を適当に選ぶ(self, v状況履歴: 状況履歴, v思考履歴: 記憶部署, vキャラクター情報:I自分の情報コンテナ) -> ThinkingMethodSelecter:
