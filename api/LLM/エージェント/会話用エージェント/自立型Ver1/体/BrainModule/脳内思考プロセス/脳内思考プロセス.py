...
from api.LLM.エージェント.会話用エージェント.自立型Ver1.体.BrainModule.脳内思考プロセス.思考グラフ.思考グラフ import 思考グラフ
...
class 脳内思考プロセス:
    ...
    def __init__(self, v自分の情報:I自分の情報コンテナ):
        ...
        self._外部状況統合所 = 状況統合所()
        self._思考グラフ = 思考グラフ(self._v自分の情報)
    ...
    async def 脳内思考プロセスを進める(self, 最新メッセージ:list[MessageUnitVer1]):
        ...
        new思考状態:思考状態 = self._思考グラフ.思考を進める(状況履歴)
