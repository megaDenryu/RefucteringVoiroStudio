...
class 専門家が結論を出すモデル(I思考モデル):
    ...
    async def 実行(self, v状況履歴: 状況履歴, v思考履歴: 記憶部署, vキャラクター情報:I自分の情報コンテナ) -> BaseModel:
    ...
    async def 専門家同士の会話シミュレート2(self, v状況履歴: 状況履歴, v思考履歴: 記憶部署, vキャラクター情報:I自分の情報コンテナ) -> ExpertConversation:
